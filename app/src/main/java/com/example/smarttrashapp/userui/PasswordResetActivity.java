...
public class PasswordResetActivity extends AppCompatActivity {
    ...
    private TextView activityTitle, titleQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityTitle = findViewById(R.id.title_tv);
    ...
    protected void onStart() {
        ...
        if (check.equals("setting")) {
            activityTitle.setText("Set Questions ");
    ...
    private void verfiyuser() {
        ...
        if (!phone.equals("") && !ans1.equals("") && !ans2.equals("")) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security Questions")) {
                            ...
                            if (!answer1.equals(ans1)) {
                                Toast.makeText(PasswordResetActivity.this, "Answer 1 Not Correct ", Toast.LENGTH_LONG).show();
                            } else if (!answer2.equals(ans2)) {
                                Toast.makeText(PasswordResetActivity.this, "Answer 2 Not Correct ", Toast.LENGTH_LONG).show();
                            } else {
                            ...
                            Toast.makeText(PasswordResetActivity.this, "You Do Not Setting Your Security Questions !", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(PasswordResetActivity.this, "Phone is wrong !", Toast.LENGTH_LONG).show();
                    }
                }
            ...
            Toast.makeText(PasswordResetActivity.this, "Complete Form ", Toast.LENGTH_LONG).show();
        }
        }
    private void setAnswers() {
        ...
        if (question1.equals("") && question2.equals("")) {
            Toast.makeText(PasswordResetActivity.this, "Answer This Questions ", Toast.LENGTH_LONG).show();
            ...
            reference.child("Security Questions").updateChildren(usermap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(PasswordResetActivity.this, "Done ! ", Toast.LENGTH_LONG).show();
